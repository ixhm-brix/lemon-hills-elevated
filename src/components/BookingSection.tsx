      ...
      <div ref={ref} className="container mx-auto px-6">
        ...
        >
          <div className="grid sm:grid-cols-3 gap-6 mb-8">
            <div>
              ...
              <input
                ...
                className="w-full bg-primary-foreground/10 border border-primary-foreground/20 px-4 py-3 text-sm text-primary-foreground font-sans focus:outline-none focus:border-accent"
              />
            </div>
            <div>
              <label className="text-xs uppercase tracking-widest mb-2 block font-sans opacity-80">
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-primary-foreground/10 border border-primary-foreground/20 px-4 py-3 text-sm text-primary-foreground font-sans focus:outline-none focus:border-accent appearance-none"
              >
                {[1, 2, 3, 4, 5, 6].map((n) => (
          ...
          <div className="text-center">
            <button className="bg-accent hover:bg-accent/90 text-accent-foreground px-12 py-3 text-sm tracking-widest uppercase transition-colors font-sans">
              Reserve Now
            </button>
          </div>
        </div>
