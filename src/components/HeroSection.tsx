    ...
    <div className="relative z-10 text-center px-6 max-w-3xl animate-fade-in-up">
      <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-10 md:p-14">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="#booking"
            className="inline-block bg-accent hover:bg-accent/90 text-accent-foreground px-8 py-3 rounded-full text-sm tracking-widest uppercase transition-all font-sans hover:shadow-lg hover:shadow-accent/25"
          >
            Book Now
          </a>
          <a
            href="#rooms"
            className="inline-block border border-white/40 bg-white/10 backdrop-blur-sm text-white hover:bg-white/20 px-8 py-3 rounded-full text-sm tracking-widest uppercase transition-all font-sans"
          >
            Explore Rooms
          </a>
        </div>
